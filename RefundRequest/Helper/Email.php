...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function sendEmail($receivers, $emailTemplate, $templateVar)
    {
        try {
            ...
            $emailNameSender = $this->scopeConfig->getValue('doku_general_config/general/sender_name', ScopeInterface::SCOPE_STORE);
            $emailSender = $this->scopeConfig->getValue('doku_general_config/general/sender_mail', ScopeInterface::SCOPE_STORE);
//            var_dump($emailSender); die();

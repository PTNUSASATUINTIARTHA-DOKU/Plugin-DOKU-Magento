...
namespace Doku\Core\Ui\Component\Listing\Column;
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                /*
                if($item['payment_method'] == \Doku\Hosted\Model\Payment\CreditCardAuthorizationHosted::CODE) {
                    $item['payment_type'] = 'Authorization';
                } else {

...
namespace Doku\Core\Controller\Payment;
...
class Request extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        $this->logger->info('===== Request controller (Core) ===== Start');

        $this->logger->info('===== Request controller (Core) ===== Find Order');
        ...
        if ($order->getEntityId()) {
            ...
            $this->logger->info('===== Request controller (Core) ===== Order Found!');
            ...
            if($configCode == "18"){
                ...
                $result['URL'] = $base_url."dokucore/service/redirect";
            ...
            $this->logger->info('===== Request controller (Core) ===== Order not found');
        }

        $this->logger->info('===== Request controller (Core) ===== end');

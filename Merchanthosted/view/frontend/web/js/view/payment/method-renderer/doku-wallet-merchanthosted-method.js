...
define(
        ...
        function (Component, $, url, alert, checkout, loader, totals) {
            ...
            return Component.extend({
                defaults: {
                    template: 'Doku_Merchanthosted/payment/doku-wallet-merchanthosted',
                    setWindow: false,
                    dokuObj: {},
                    dokuDiv: ''
                },
                ...
                getDescription: function(){
                     return window.checkoutConfig.payment.doku_wallet_merchanthosted.description
                },
